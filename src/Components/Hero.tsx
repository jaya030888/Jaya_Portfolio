    ...
    <section className="hero">
      <div className="hero-container">
        <div className="hero-content">
          <h1 className="hero-title">Unbox stories worth talking about</h1>
          ...
          <div className="hero-actions">
            <a href="/login" className="btn-primary hero-btn">
              <span>Log-in / Sign-up now</span>
              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="13" viewBox="0 0 14 13" fill="none" aria-hidden="true" style={{marginLeft: '8px'}}>
          ...
          <div className="hero-text-wrap">
            <p className="hero-handwritten">Shipping to the USA & Canada</p>
          </div>
        </div>
